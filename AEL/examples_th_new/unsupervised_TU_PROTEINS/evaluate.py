...
if __name__ == '__main__':
    ...
    eva = None
    if args.aug.lower() in ['dnodes', 'subgraph', 'random2', 'random3', 'random4', 'minmax', "eva"]:
        with open(f'/home/xtanghao/THPycharm/AEL_main/examples_th_new/unsupervised_TU_PROTEINS/ael_results/pops_best/population_generation_7.json', 'r', encoding='utf-8') as file:
    ...
    model = simclr(args.hidden_dim, args.num_gc_layers, gamma=args.gamma).to(device)
    # print(model)
    ...
    with open('results/final_condition_' + args.DS + '_' + args.aug + '_' + str(args.gamma), 'a+') as f:
