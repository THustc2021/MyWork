...
def arg_parse():
    ...
    parser.add_argument('--hidden-dim', dest='hidden_dim', type=int, default=32,
            help='')
    parser.add_argument('--aug-point-path', dest='aug_point_path', type=str, default='/home/xtanghao/THPycharm/AEL_main/examples/unsupervised_TU_COLLAB/ael_results/pops/population_generation_0.json',
            help='')
