...
### output path ###
output_path = "./th_llm" # default folder for ael outputs
...
n_pop = 0 # number of populations, default = 10
operators = ['i1']  # evolution operators: ['e1','e2','m1','m2'], default = ['e1','m1']
m = 0  # number of parents for 'e1' and 'e2' operators, default = 2
operator_weights = [1] # weights for operators, i.e., the probability of use the operator in each iteration , default = [1,1,1,1]
