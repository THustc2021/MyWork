...
# 绘制曲线图
plt.plot(x, y_best, label='best', color='b', linewidth=2, linestyle='-', marker='o', markersize=6)
plt.plot(x, y_mean, label='mean', color='r', linewidth=2, linestyle='--', marker='s', markersize=6)
