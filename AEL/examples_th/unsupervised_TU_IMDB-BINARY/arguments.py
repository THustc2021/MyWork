...
def arg_parse():
    ...
    parser.add_argument('--DS', dest='DS', help='Dataset',default="IMDB-BINARY")
    ...
    parser.add_argument('--hidden-dim', dest='hidden_dim', type=int, default=32,
            help='')
    parser.add_argument('--aug-point-path', dest='aug_point_path', type=str, default='ael_results/history/pop_1_0_e1.json',
            help='')
