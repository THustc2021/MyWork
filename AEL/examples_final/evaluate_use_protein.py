...
if __name__ == '__main__':
    ...
    for ti in range(test_time):
        ...
        with open(os.path.join(save_dir, f'final_fitnessrelation_use_protein_' + args.DS + '_' + args.aug + '_' + str(args.gamma) + ".txt"), 'a+') as f:
    ...
    # 保存平均结果
    tpe = ('local' if args.local else '') + ('prior' if args.prior else '')
    with open(os.path.join(save_dir, f'final_curve_use_protein_' + args.DS + '_' + args.aug + '_' + str(args.gamma) + ".txt"), 'a+') as f:
