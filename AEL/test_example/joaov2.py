...
if __name__ == '__main__':
    ...
    # for aug_name in ["dnodes", 'pedges', "subgraph", "mask_nodes"]:
    for aug_name in ['pedges', "subgraph", "mask_nodes"]:
        save_dir = osp.join("results", args.DS, aug_name)
        ...
        for ti in range(test_time):
            ...
            for epoch in range(1, epochs+1):
                ...
                for data in dataloader:
                    ...
                    if aug_name== 'dnodes' or aug_name== 'subgraph' or aug_name== 'random2' or aug_name== 'random3' \
                            or aug_name== 'random4' or aug_name== 'minmax':
            ...
            with open(os.path.join(save_dir,
                                   f'final_condition' + args.DS + '_' + aug_name + '_' + str(args.gamma) + ".txt"),
                      'a+') as f:
        ...
        tpe = ('local' if args.local else '') + ('prior' if args.prior else '')
        with open(
                os.path.join(save_dir, f'final_condition' + args.DS + '_' + aug_name + '_' + str(args.gamma) + ".txt"),
                'a+') as f:
