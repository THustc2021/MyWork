...
class JigSawDatasetv2(data.Dataset):
    ...
    def __retrive_permutations(self, classes):
        all_perm = np.load('/home/xtanghao/DocRec/bin/permutations/permutations_hamming_max_%d.npy' % (classes))
...
if __name__ == '__main__':
    ...
    JigSawDatasetv2("/home/xtanghao/THPycharm/dataset/DocUnet Benchmark/scan")[0]