...
class GeoDecoder(nn.Module):
    def __init__(self,  norm_fn, acf):
        ...
        self.attn0 = AttentionBlock(64, 64, 16, 64, norm, acf)
        self.add_and_norm5 =  Add_and_Norm(64, acf)

        self.attn = AttentionBlock(64, 32, 32, 32, norm, acf, type=1)
    ...
    def forward(self, x0, x1, x2, x3, f, x):
        ...
        f4 = self.add_and_norm5(self.attn0(f3, f3), f3)
        # f4 = f
