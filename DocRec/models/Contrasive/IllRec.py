...
class ClsHead(nn.Module):
    ...
    def __init__(self, input_channel, output_channel=128):
        ...
        self.conv_head = nn.Conv2d(input_channel, input_channel, 3, 1, 1)
...
class ContrasiveIllRec(nn.Module):
    ...
    def forward(self, inp):
        ...
        inner_feature, f = self.ill_decoder(x0, x1, x2, x3, x)

        inner_feature = self.cls_inner(inner_feature)
        f = self.cls_f(f)
